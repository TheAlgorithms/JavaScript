...
function functionalQuickSort (items) {
  ...
  return functionalQuickSort(smaller)
    .concat([x])
    .concat(functionalQuickSort(larger))
}

// Sort an array having numbers
const items = [3, 5, 1, 4, 2]
// Array before Sort
console.log(functionalQuickSort(items))
const returnedItems = functionalQuickSort(items)
// Array after Sord
console.log(returnedItems)

// Sort an array having literals
const anotherItems = ['b', 'z', 'a', 'c', 't', 'o']
console.log(functionalQuickSort(anotherItems))
