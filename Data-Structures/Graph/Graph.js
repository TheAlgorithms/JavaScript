class Graph {
  ...
  topologicalSortUtil(v, visited, stack) {
    ...
    // to thisvertex
    for (i = 0; i < this.adjacencyMap[v].length; i++) {
      if (!visited[this.adjacencyMap[v][i]]) {
        this.topologicalSortUtil(this.adjacencyMap[v][i], visited, stack)
      }
    }
  ...
  topologicalSort() {
    ...
    for (let i = 0; i < this.numberOfVertex + 1; i++) {
      visited[i] = false
    }
