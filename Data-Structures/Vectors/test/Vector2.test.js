...
describe('Vector2', () => {
  ...
  describe('#add', () => {
    it('should add two vectors correctly', () => {
      ...
      expect(new Vector2(-3.3, -9).add(new Vector2(-2.2, 3)).equalsApproximately(new Vector2(-5.5, -6), 0.000001)).toBe(
        true
      )
    })
  })
  ...
  describe('#multiply', () => {
    it('should multiply two vectors correctly', () => {
      ...
      expect(new Vector2(3.41, -7.12).multiply(-3.1).equalsApproximately(new Vector2(-10.571, 22.072), 0.000001)).toBe(
        true
      )
    })
  })
  ...
  describe('#rotate', () => {
    it('should rotate a vector correctly', () => {
      ...
      expect(new Vector2(1.23, -4.56).rotate(Math.PI).equalsApproximately(new Vector2(-1.23, 4.56), 0.000001)).toBe(
        true
      )
    })
  })
