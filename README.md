...
**3**. Go join a project and start contributing or create your own group project. Don't be shy and enjoy creating things together! [Check out this guide](https://github.com/zero-to-mastery/start-here-guidelines/blob/master/Get%20Started.md) for more information on selecting a project. We have over 20 projects for all level of programmers!
